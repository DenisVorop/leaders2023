...
const PostHogPlayground = () => {
  ...
  return <div className='flex flex-wrap gap-3'>
    {gameStage.map((id) => <div key={id} id={id} className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
...
<ol className="relative text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400">
    {activity?.actions?.results?.map((el, id) => <li key={el?.name} className="mb-10 ml-6">
