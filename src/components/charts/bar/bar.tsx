...
const Chart = ({
    ...
    return (
        <div className={`flex flex-col justify-between items-start gap-5 card `} style={{ gridColumn }}>
            <div className="flex flex-col items-start gap-2">
                ...
                <div className="flex flex-col items-start">
                    <div className="font-bold text-2xl leading-150 text-left tracking-tighter text-gray-900">{`${mainInfo} ${replaceEnding(mainInfo, textArray)}`}</div>
