...
const AlertPrompt = ({ children }) => {
  return <div id="toast-interactive" className="w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-400" role="alert">
    <div className="flex">
      <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-purple-500 bg-blue-100 rounded-lg dark:text-purple-300 dark:bg-blue-900">
      ...
      <div className="ml-3 text-sm font-normal">
        ...
        <div className="mb-2 text-sm font-normal">{children}</div>
