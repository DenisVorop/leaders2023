...
const AlertMessage = ({ children }) => {
  return <div id="toast-notification" className="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300" role="alert">
    ...
    <div className="flex items-center">
      ...
      <div className="ml-3 text-sm font-normal">
        ...
        <span className="text-xs font-medium text-purple-600 dark:text-purple-500">a few seconds ago</span>
      </div>
    </div>
  </div>
}
